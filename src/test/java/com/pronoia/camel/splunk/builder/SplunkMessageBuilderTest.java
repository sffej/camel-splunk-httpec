 ...
 */
public class SplunkMessageBuilderTest extends CamelBlueprintTestSupport {
    ...
    public void setUp() throws Exception {
        super.setUp();
        splunkMessageBuilder = new SplunkMessageBuilder();
        ...
        exchangeIn.setProperty("CamelCreatedTimestamp","Wed Jun 21 09:10:37 PDT 2017");
    ...
    public void process() throws Exception {
        ...
        splunkMessageBuilder.builder(exchangeIn);
